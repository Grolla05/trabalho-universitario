      ...
      <div className="container">
        <div className="sanitation-content-grid" style={{ 
          ...
          <motion.div 
            ...
            style={{ y: heroY, opacity: heroOpacity, textAlign: isMobile ? 'center' : 'left' }}
          >
            <div className="pill" style={{ marginBottom: isMobile ? '1.25rem' : '2rem' }}>
              <span className="dot" style={{ backgroundColor: 'var(--accent)' }}></span>
              <span className="pill-text">MAPEAMENTO SISTÊMICO</span>
            </div>

            <h1 className="hero-title" style={{ fontSize: 'clamp(2rem, 5vw, 4.5rem)', lineHeight: 1.1, marginBottom: '1.5rem' }}>
